...
TIM PENGEMBANG
1. Abiyyu Syauqi Admaja (K-Means Clustering from scratch, Rule-based Heuristics, Analisis Evaluasi)
2. Ilmanza Nafis Adidarma (Image Preprocessing, Visualisasi Data, Komparasi Waktu Eksekusi, Silhouette Scoring)
3. Evans Lordy Arrow Sarumaha (Fuzzy C-Means, Perekapan gambar, Pengujian akurasi hasil dengan ground truth)

DESKRIPSI PROYEK
Sistem ini dirancang untuk mendeteksi dan memisahkan objek sampah organik dan anorganik dari latar belakangnya secara otomatis menggunakan fitur ruang warna HSV (Hue, Saturation, Value) dengan implementasi K-means serta pembandingnya yakni Fuzzy C-Means. 
...
2. Fuzzy C-Means atau FCM (Soft Clustering): Diimplementasikan menggunakan pustaka/library scikit-fuzzy untuk menangani ketidakpastian batas warna akibat pantulan cahaya.
